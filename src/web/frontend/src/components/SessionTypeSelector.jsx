  ...
  const sessionTypes = [
    {
      ...
      description: 'Chat with AI assistant for coding tasks, questions, and more',
      color: 'blue',
    },
    {
      id: 'deep_plot',
      ...
      description: 'Autonomous data analysis with interactive visualizations',
      color: 'purple',
    },
    {
      id: 'mle',
      ...
      description: 'MCTS-based ML training with parallel exploration',
      color: 'green',
    },
  ];
