...
class HeadlessHandler:
    ...
    - Logs interaction to database with cumulative_state
    """
    ...
    def handle_init(
        ...
        try:
            ...
            # 3. Generate screenshot using kaleido
    ...
    def handle_command(
        ...
        try:
            ...
            # 6. Generate screenshot using kaleido
            screenshot_path, screenshot_size_kb = self._generate_screenshot(
    ...
    def _generate_screenshot(
        ...
        try:
            ...
            # Generate screenshot with kaleido
